	...
	for (let columnHeader of this.currentColumns) {
		...
		if (!this.ignoreSearchColumns.includes(columnHeader)) {
			if (this.inputTypes.get(columnHeader) === 'checkbox') {
				...
				headerContainer = this._createBetweenLikeInputHeaderElement("datetime-local", columnHeader, this.tableId, this.saveStore);
			} else if (this.inputTypes.get(columnHeader) === 'date') {
				headerContainer = this._createBetweenLikeInputHeaderElement("date", columnHeader, this.tableId, this.saveStore);
			} else if (this.inputTypes.get(columnHeader) === 'number') {
				headerContainer = this._createBetweenLikeInputHeaderElement("number", columnHeader, this.tableId, this.saveStore);
			}
			else {
		...
		for ([key, value] of this.hKMap) {
			if (this.currentColumns.includes(key)) {
				...
				if (current != null && current.value != "") {
					...
					} else if (['datetime', 'date', 'number'].includes(this.inputTypes.get(key))) {
