...
CREATE TABLE `login_roles` (
  `login_role_id` bigint NOT NULL AUTO_INCREMENT,
  `role_name` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`login_role_id`),
  UNIQUE KEY `UKl4pxidf2rj117ior8wwfo3gf6` (`role_name`)
...
INSERT INTO `login_roles` VALUES (1,'ADMIN'),(2,'LIBRARIAN'),(3,'USER');
...
-- Dump completed on 2026-01-22 19:28:39
